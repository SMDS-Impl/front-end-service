...
export default function Login() {
    const loginData = useActionData<LoginData>()
        ...
        <div className="font-display flex h-screen w-screen flex-col items-center  justify-center bg-black font-primary text-white">
            <div className="rounded-lg bg-white p-4 shadow-sm sm:p-6 lg:p-8">
                <form
                    ...
                    autoComplete="off"
                    aria-errormessage={
                        loginData?.formError ? 'form-error-message' : undefined
                    }
                >
                    {/* Logo */}
                    ...
                    <div className="pt-6">
                        ...
                        <Input
                            ...
                            defaultValue={loginData?.fields?.email}
                            aria-invalid={Boolean(
                                loginData?.fieldErrors?.email
                            )}
                            aria-errormessage={
                                loginData?.fieldErrors?.email
                                    ? 'email-error'
                    ...
                    <div className="py-6">
                        <div className="flex justify-between">
                            ...
                            <span className="text-xs text-[#A5A8B9]">
                                Forgot Password?
                            </span>
                        </div>
                        <div className="flex justify-between">
                            <Input
                                ...
                                aria-invalid={Boolean(
                                    loginData?.fieldErrors?.password
                                )}
                                aria-errormessage={
                                    loginData?.fieldErrors?.password
                                        ? 'password-error'
                    ...
                    <div className="mt-4 flex px-8">
                        ...
                        <Link className="px-2 text-[#3751FF]" to="/register">
                            Sign up
                        </Link>
                    </div>
                </form>
